...
def generateInsight():
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            ...
            - The opportunities already created in the database may or may not have feedback on them, use the feedback if you have it to improve the creation of the opportunities, in the feedback you will have the general grade of it which is rating_feedback from 0 to 5 being 0 very bad and 5 very good, so take into account grades between 4 and 5 and you will also have if the reason, objective and strategy created makes sense or not and a possible comment about the opportunity. 
...
def insert_into_database(action_plan):
    ...
    val = (
        ...
        action_plan_dict.get('Motivo da oportunidade'),
